sap.ui.define([
    ...
    return Controller.extend("pe.umadev.supplyapproval.controller.Principal", {
        onInit: function () { 
        ...
        initSampleDataModel: function () {
            ...
            var productosUri = jQuery.sap.getModulePath("pe.umadev.supplyapproval", "/mock/productos.json");
            console.log(productosUri);
            var oDateFormat = DateFormat.getDateInstance({ source: { pattern: "timestamp" }, pattern: "dd/MM/yyyy" });
            var oModel = new JSONModel(); 
            jQuery.ajax(productosUri, {
                dataType: "json",
